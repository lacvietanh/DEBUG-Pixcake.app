<template>
    ...
    >
        <div class="claTitle">
            <div class="claCloseBtn">
                <i class="el-icon-close " @click="onCloseClick">
                </i>
            </div>
        </div>
...
export default {
    ...
    methods: {
        onCloseClick() {
            this.PointMemberCloseClick()
            ipcRenderer.send('close-memberVip-window', {})
        },
        onRetryClick() {
            this.loadingStatus = 'loading'
            ipcRenderer.send('activity-reload', {})
        }
    },
    mounted() {
        ...
        ipcRenderer.send('memberVipPlan-mounted', null)
    }
}
</script>
